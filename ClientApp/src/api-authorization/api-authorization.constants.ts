export const ApplicationName = 'LevricksHerbsDemo';
...
let applicationPaths: ApplicationPathsType = {
  DefaultLoginRedirectPath: '/LevricksHerbiary/',
  ...
  IdentityRegisterPath: 'LevricksHerbiary/Identity/Account/Register',
  IdentityManagePath: 'LevricksHerbiary/Identity/Account/Manage'
};
